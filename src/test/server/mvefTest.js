...
describe("mvef", function () {
  describe("#mvef()", function () {
    it("step by step", function (done) {
      ...
      utils.setMatrixElementsScale(meanReturnRatesMatrix, 6);
      ...
      utils.setMatrixElementsScale(expectedReturnRatesCovariance, 6);
      var returnRatesCovariance = portfolioStats.covariance(returnRatesMatrix);
      utils.setMatrixElementsScale(returnRatesCovariance, 6);
      assert.deepEqual(returnRatesCovariance, expectedReturnRatesCovariance);
