// flow-typed signature: 341274f15f94a7862117e1fd589d934c
// flow-typed version: <<STUB>>/numeric_v1.2.6/flow_v0.134.0
...
declare module 'numeric' {
  ...
  declare type MultidimensionalArray<T> =
    | T[][]
    | T[][][]
    | T[][][][]
    | T[][][][][]
  ...
  declare interface Numeric {
    ...
    clone<T: NonNullPrimitive[] | MultidimensionalArray<NonNullPrimitive>>(
      x: T
    ): T;
    cloneV(x: NonNullPrimitive[]): NonNullPrimitive[];
    cloneeq(x: NonNullPrimitive[]): NonNullPrimitive[];
    cloneeq<T: NonNullPrimitive[] | MultidimensionalArray<NonNullPrimitive>>(
      x: T
    ): T;
    ...
    lshift<T: MultidimensionalMatrix>(
      x: T,
      y: T | Scalar,
      ...args: Array<T | Scalar>
    ): T;
    ...
    rshift<T: MultidimensionalMatrix>(
      x: T,
      y: T | Scalar,
      ...args: Array<T | Scalar>
    ): T;
    ...
    rrshift<T: MultidimensionalMatrix>(
      x: T,
      y: T | Scalar,
      ...args: Array<T | Scalar>
    ): T;
    ...
    atan2<T: MultidimensionalMatrix>(
      x: T,
      y: T | Scalar,
      ...args: Array<T | Scalar>
    ): T;
    ...
    setBlock<T: MultidimensionalMatrix>(
      x: T,
      from: Vector,
      to: Vector,
      b: T
