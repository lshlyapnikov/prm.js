// flow-typed signature: e5669c02423c93483b782b0f2f6d2ece
// flow-typed version: <<STUB>>/@js-joda/core_v3.1.0/flow_v0.134.0
 ...
 */
declare export class TemporalField  {
 ...
 */
adjustInto<R: Temporal>(temporal: R, newValue: number): R;
name(): string;
displayName(): string;
 ...
 */
declare export class TemporalUnit  {
 ...
 */
declare export class ValueRange  {
 ...
 * `Period` and `Duration`.
 */
declare export class TemporalAmount  {
 ...
 */
declare export class TemporalAccessor  {
 ...
 * discussion of the issues.
 */
declare export class Temporal mixins TemporalAccessor {
isSupported(field: TemporalField): boolean;
 ...
 */
declare export class TemporalAdjuster  {
adjustInto(temporal: Temporal): Temporal;
}declare export class TemporalQuery<R>  {
 ...
 */
declare export class ChronoField mixins TemporalField {
 ...
 */
declare export class ChronoUnit mixins TemporalUnit {
...
isTimeBased(): boolean;
toString(): string;
}declare var IsoFields: typeof npm$namespace$IsoFields;

      declare var npm$namespace$IsoFields: {|
        
        
        DAY_OF_QUARTER: typeof IsoFields$DAY_OF_QUARTER,
QUARTER_OF_YEAR: typeof IsoFields$QUARTER_OF_YEAR,
WEEK_OF_WEEK_BASED_YEAR: typeof IsoFields$WEEK_OF_WEEK_BASED_YEAR,
WEEK_BASED_YEAR: typeof IsoFields$WEEK_BASED_YEAR,
WEEK_BASED_YEARS: typeof IsoFields$WEEK_BASED_YEARS,
QUARTER_YEARS: typeof IsoFields$QUARTER_YEARS,
 ...
 */
declare export var IsoFields$DAY_OF_QUARTER: TemporalField;
 ...
 */
declare export var IsoFields$QUARTER_OF_YEAR: TemporalField;


/**
 * The field that represents the week-of-week-based-year.
 */
declare export var IsoFields$WEEK_OF_WEEK_BASED_YEAR: TemporalField;


/**
 * The field that represents the week-based-year.
 */
declare export var IsoFields$WEEK_BASED_YEAR: TemporalField;
 ...
 */
declare export var IsoFields$WEEK_BASED_YEARS: TemporalUnit;
 ...
 */
declare export var IsoFields$QUARTER_YEARS: TemporalUnit;declare var TemporalAdjusters: typeof npm$namespace$TemporalAdjusters;

      declare var npm$namespace$TemporalAdjusters: {|
        
        dayOfWeekInMonth: typeof TemporalAdjusters$dayOfWeekInMonth,
firstDayOfMonth: typeof TemporalAdjusters$firstDayOfMonth,
firstDayOfNextMonth: typeof TemporalAdjusters$firstDayOfNextMonth,
firstDayOfNextYear: typeof TemporalAdjusters$firstDayOfNextYear,
firstDayOfYear: typeof TemporalAdjusters$firstDayOfYear,
firstInMonth: typeof TemporalAdjusters$firstInMonth,
lastDayOfMonth: typeof TemporalAdjusters$lastDayOfMonth,
lastDayOfYear: typeof TemporalAdjusters$lastDayOfYear,
lastInMonth: typeof TemporalAdjusters$lastInMonth,
next: typeof TemporalAdjusters$next,
nextOrSame: typeof TemporalAdjusters$nextOrSame,
previous: typeof TemporalAdjusters$previous,
previousOrSame: typeof TemporalAdjusters$previousOrSame,
 ...
 */
declare function TemporalAdjusters$dayOfWeekInMonth(ordinal: number, dayOfWeek: DayOfWeek): TemporalAdjuster
 ...
 * ```
 */
declare function TemporalAdjusters$firstDayOfMonth(): TemporalAdjuster
 ...
 * ```
 */
declare function TemporalAdjusters$firstDayOfNextMonth(): TemporalAdjuster
 ...
 * ```
 */
declare function TemporalAdjusters$firstDayOfNextYear(): TemporalAdjuster
 ...
 * ```
 */
declare function TemporalAdjusters$firstDayOfYear(): TemporalAdjuster
 ...
 * and `DAY_OF_MONTH` fields and the `DAYS` unit, and assumes a seven day week.
 */
declare function TemporalAdjusters$firstInMonth(dayOfWeek: DayOfWeek): TemporalAdjuster
 ...
 * ```
 */
declare function TemporalAdjusters$lastDayOfMonth(): TemporalAdjuster
 ...
 * ```
 */
declare function TemporalAdjusters$lastDayOfYear(): TemporalAdjuster
 ...
 * and `DAY_OF_MONTH` fields and the `DAYS` unit, and assumes a seven day week.
 */
declare function TemporalAdjusters$lastInMonth(dayOfWeek: DayOfWeek): TemporalAdjuster
 ...
 */
declare function TemporalAdjusters$next(dayOfWeek: DayOfWeek): TemporalAdjuster
 ...
 * field and the `DAYS` unit, and assumes a seven day week.
 */
declare function TemporalAdjusters$nextOrSame(dayOfWeek: DayOfWeek): TemporalAdjuster
 ...
 */
declare function TemporalAdjusters$previous(dayOfWeek: DayOfWeek): TemporalAdjuster
 ...
 * field and the `DAYS` unit, and assumes a seven day week.
 */
declare function TemporalAdjusters$previousOrSame(dayOfWeek: DayOfWeek): TemporalAdjuster
declare var TemporalQueries: typeof npm$namespace$TemporalQueries;

      declare var npm$namespace$TemporalQueries: {|
        
        chronology: typeof TemporalQueries$chronology,
localDate: typeof TemporalQueries$localDate,
localTime: typeof TemporalQueries$localTime,
offset: typeof TemporalQueries$offset,
precision: typeof TemporalQueries$precision,
zone: typeof TemporalQueries$zone,
zoneId: typeof TemporalQueries$zoneId,
        
        
        
        
      |}
declare function TemporalQueries$chronology(): TemporalQuery<Chronology | null>


declare function TemporalQueries$localDate(): TemporalQuery<LocalDate | null>


declare function TemporalQueries$localTime(): TemporalQuery<LocalTime | null>


declare function TemporalQueries$offset(): TemporalQuery<ZoneOffset | null>


declare function TemporalQueries$precision(): TemporalQuery<TemporalUnit | null>


declare function TemporalQueries$zone(): TemporalQuery<ZoneId | null>


declare function TemporalQueries$zoneId(): TemporalQuery<ZoneId | null>
...
zone(): ZoneId;
}declare export class Duration mixins TemporalAmount {
...
}declare export class Instant mixins Temporal, TemporalAdjuster {
...
}declare export class LocalDate mixins ChronoLocalDate, TemporalAdjuster {
...
year(): number;
}declare export class LocalDateTime mixins ChronoLocalDateTime, TemporalAdjuster {
...
year(): number;
}declare export class LocalTime mixins Temporal, TemporalAdjuster {
...
}declare export class MonthDay mixins TemporalAccessor, TemporalAdjuster {
...
}declare export class Period mixins TemporalAmount {
static ZERO: Period;
...
years(): number;
}declare export class Year mixins Temporal, TemporalAdjuster {
...
}declare export class YearMonth mixins Temporal, TemporalAdjuster {
 ...
 */
declare export class ZonedDateTime mixins ChronoZonedDateTime {
...
zone: ZoneId,
preferredOffset?: ZoneOffset | null): ZonedDateTime;
...
toJSON(): string;
toString(): string;
}declare export class ZoneOffset mixins ZoneId, TemporalAdjuster {
...
toString(): string;
totalSeconds(): number;
}declare export class ZoneRegion mixins ZoneId {
static ofId(zoneId: string): ZoneId;
constructor(): this;
id(): string;
rules(): ZoneRules;
}declare export class DayOfWeek mixins TemporalAccessor, TemporalAdjuster {
...
toString(): string;
value(): number;
}declare export class Month mixins TemporalAccessor, TemporalAdjuster {
...
toString(): string;
value(): number;
}declare export class DateTimeFormatter  {
...
}declare export class DateTimeFormatterBuilder  {
constructor(): this;
...
width: number,
maxWidth: number,
base: ChronoLocalDate | number): DateTimeFormatterBuilder;
...
}declare export class DecimalStyle  {
constructor(): this;
...
toString(): string;
zeroDigit(): string;
}declare export class ResolverStyle  {
...
toJSON(): string;
toString(): string;
}declare export class SignStyle  {
...
toJSON(): string;
toString(): string;
}declare export class ParsePosition  {
constructor(index: number): this;
getIndex(): number;
setIndex(index: number): void;
getErrorIndex(): number;
setErrorIndex(errorIndex: number): void;
}declare export class ZoneOffsetTransition  {
static of(
transition: LocalDateTime,
offsetBefore: ZoneOffset,
offsetAfter: ZoneOffset): ZoneOffsetTransition;
constructor(): this;
...
} declare export interface ZoneOffsetTransitionRule {} declare export class ZoneRules  {
...
}declare export class ZoneRulesProvider  {
static getRules(zoneId: string): ZoneRules;
static getAvailableZoneIds(): string[];
}declare export type Chronology = IsoChronology;declare export class IsoChronology  {
static isLeapYear(prolepticYear: number): boolean;
constructor(): this;
equals(other: any): boolean;
resolveDate(fieldValues: any, resolverStyle: any): any;
toString(): string;
}declare export class ChronoLocalDate mixins Temporal, TemporalAdjuster {
adjustInto(temporal: Temporal): Temporal;
format(formatter: DateTimeFormatter): string;
isSupported(fieldOrUnit: TemporalField | TemporalUnit): boolean;
}declare export class ChronoLocalDateTime mixins Temporal, TemporalAdjuster {
adjustInto(temporal: Temporal): Temporal;
chronology(): Chronology;
toEpochSecond(offset: ZoneOffset): number;
toInstant(offset: ZoneOffset): Instant;
}declare export class ChronoZonedDateTime mixins Temporal {
...
toEpochSecond(): number;
toInstant(): Instant;
} declare export interface Locale {} declare export function nativeJs(date: Date | any, zone?: ZoneId): TemporalAccessor
...
declare export function use(plugin: Function): any
declare export class DateTimeException mixins Error {
constructor(message?: string, cause?: Error): this;
}declare export class UnsupportedTemporalTypeException mixins DateTimeException {}declare export class DateTimeParseException mixins Error {
constructor(message?: string, text?: string, index?: number, cause?: Error): this;
parsedString(): string;
errorIndex(): number;
}declare export class ArithmeticException mixins Error {}declare export class IllegalArgumentException mixins Error {}declare export class IllegalStateException mixins Error {}declare export class NullPointerException mixins Error {}declare export var __esModule: true;
}
...
declare module '@js-joda/core/src/OffsetDateTime' {
  declare module.exports: any;
}

declare module '@js-joda/core/src/OffsetTime' {
  declare module.exports: any;
}
...
declare module '@js-joda/core/src/temporal/DefaultInterfaceTemporal' {
  declare module.exports: any;
}
...
declare module '@js-joda/core/src/OffsetDateTime.js' {
  declare module.exports: $Exports<'@js-joda/core/src/OffsetDateTime'>;
}
declare module '@js-joda/core/src/OffsetTime.js' {
  declare module.exports: $Exports<'@js-joda/core/src/OffsetTime'>;
}
...
declare module '@js-joda/core/src/temporal/DefaultInterfaceTemporal.js' {
  declare module.exports: $Exports<'@js-joda/core/src/temporal/DefaultInterfaceTemporal'>;
}
